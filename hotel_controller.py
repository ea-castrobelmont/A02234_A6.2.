...
class HotelController:
    ...
    def create_hotel(self, hotel_name: str) -> bool | Hotel:
        ...
        if self.db_h.create(hotel, self.TABLE_NAME):
            return hotel
    ...
    def update_hotel(self) -> bool:
        ...
        Updates a hotel
        '''
        return self.db_h.update(self.TABLE_NAME)

    def delete_hotel(self, hotel: Hotel) -> bool:
        '''
        Deletes a hotel
        '''
        return self.db_h.delete(hotel, self.TABLE_NAME)
    ...
    def find_by_name(self, name: str) -> Hotel | None:
        ...
        data = self.db_h.find_by(self.TABLE_NAME, 'name', name)
    ...
    def drop_table(self) -> True:
        ...
        '''
        return self.db_h.drop_table(self.TABLE_NAME)
